...
"""
                ...
                print(
                    f"  {sig['symbol']} SL HIT -> deactivated"
                )
...
"""
                    ...
                    print(
                        f"  {sig['symbol']} TP HIT -> deactivated"
                    )
            ...
            print(
                f"  Error checking {sig.get('symbol')}: {e}"
            )
